                    ...
                    <div className="flex-1">
                      <blockquote className="mt-8 flex-1">
                        <p className="text-md font-semibold leading-snug text-black">
                          ...
                          explanations helped me understand every line and the
                          tutorial was just amazing. Great experience!
                        </p>
                      </blockquote>
                    </div>
                    ...
                    <div className="flex-1">
                      <blockquote className="mt-8 flex-1">
                        <p className="text-md font-semibold leading-snug text-black">
                          ...
                          better assistance than what I received from
                          MindMosaic. Their attention to detail and expertise in
