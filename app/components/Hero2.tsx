          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex-1 bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-sm text-gray-700 h-20 overflow-auto">
                ...
                ensures your success, making assignment writing a more
                manageable and rewarding journey.
              </p>
            </div>
            ...
            <div className="flex-1 bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-sm text-gray-700 h-20 overflow-auto">
                ...
                qualified writers possesses the expertise to compose a wide
                range of research papers. Whether you are pursuing academic
                excellence or seeking assistance with your scholarly endeavors,
                we are dedicated to delivering top-notch papers tailored to your
                specific needs.
              </p>
            </div>
          </div>
