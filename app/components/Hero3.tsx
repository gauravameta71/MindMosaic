...
const OurGuarantee = () => {
  return (
    <>
      {/* // 2 */}
      <div className="max-w-4xl mx-auto px-2 mt-5 text-black pb-14 ">
        <div className="text-center">
          <h2 className="font-semibold text-4xl">Features you'll love</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-10">
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl">Plagiarism free</h3>
              <p className="mt-1 text-gray-500">
                {" "}
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl">Quality Work</h3>
              <p className="mt-1 text-gray-500">
                {" "}
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl">Modification</h3>
              <p className="mt-1 text-gray-500">
                {" "}
